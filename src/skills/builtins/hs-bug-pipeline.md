---
name: hs-bug-pipeline
description: "Bug fix pipeline: bug analysis → code fix → PR → release. Use when asked to fix a bug end-to-end, or when the user says 'help me fix and release issue #X'."
